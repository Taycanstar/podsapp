...
//
//  ExerciseEquipmentResolver.swift
//
//  Provides deterministic equipment metadata for each exercise id so filters
//  no longer rely on substring guesses at runtime. This resolver maps both the
//  CSV `equipment` column and exercise naming heuristics (e.g. Landmine) into
//  the canonical `Equipment` enum used throughout the app.
//
