...
//  Pods
//
//  Created by Dimi Nunez on 12/16/24.
//
//
//import Foundation
//
...
//        
//        init(podId: Int, networkManager: NetworkManager, userEmail: String) {
//            self.podId = podId
...
//            loadMoreLogs(refresh: true)  // Reload logs with new email
//        }
//    
//     func loadCachedLogs() {
...
//                try? PodItemActivityLog(from: jsonLog)
//            }
//        }
//    }
//    
...
//    init(podId: Int = 0, networkManager: NetworkManager = NetworkManager(), userEmail: String = "") {
//        self.podId = podId
//        self.networkManager = networkManager
//        self.userEmail = userEmail
//        print("ActivityLogManager: Initialized with podId \(podId) and userEmail \(userEmail).")
//        loadCachedLogs()
//    }
    init() {
           self.networkManager = NetworkManager()
