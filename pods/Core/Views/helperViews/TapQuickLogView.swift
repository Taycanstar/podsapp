...
struct TapQuickLogView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            // Placeholder for specific content of TapQuickLogView
            Text("Manually log food with Quick Log")
...
#if DEBUG
struct TapQuickLogView_Previews: PreviewProvider {
