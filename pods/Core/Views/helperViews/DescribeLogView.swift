...
struct DescribeLogView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            Image("logfood00") // Image for this view
                .resizable()
                .scaledToFit()
            ...
            Text("Describe your meal in the search bar")
...
#if DEBUG
struct DescribeLogView_Previews: PreviewProvider {
