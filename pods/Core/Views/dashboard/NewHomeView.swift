...
private var remainingCal: Double { vm.remainingCalories }
    ...
    // Wrapped in separate view to break closure capture chain and prevent stack overflow
    // from type metadata resolution of closures capturing NewHomeView's 250+ properties
    // All vm properties are accessed via EnvironmentObject inside the wrapper
    private var timelineSection: AnyView {
        AnyView(
            TimelineSectionWrapper(
                ...
                showCoachCopyToast: $showCoachCopyToast,
                pendingCoachMessageText: $pendingCoachMessageText,
...
// Timeline components extracted to:
//   - TimelineComponents.swift
//   - TimelineEventViews.swift
//   - TimelineDetailViews.swift
//   - AddActivityComponents.swift
