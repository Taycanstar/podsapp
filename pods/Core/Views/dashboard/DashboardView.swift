...
//                 HStack {
//                     expenditureMetricCard(title: "Core TDEE", value: formatCalories(snapshot.tdeeCore))
//                     Divider()
//                         .frame(height: 42)
//                     expenditureMetricCard(title: "Display Burn", value: formatCalories(snapshot.tdeeDisplay))
//                 }
//                 .padding(.vertical, 4)

//                 if let overlay = snapshot.activityOverlay, abs(overlay) >= 1 {
//                     HStack(spacing: 6) {
//                         Image(systemName: overlay >= 0 ? "figure.walk" : "bed.double")
//                             .font(.caption)
//                         Text(overlay >= 0 ? "+\(formatCalories(abs(overlay), suffix: "")) activity" : "\(formatCalories(overlay, suffix: "")) recovery")
//                             .font(.caption)
//                             .foregroundStyle(.secondary)
//                     }
//                 }
